...
fn symbol_kind_key(kind: SymbolKind) -> u8 {
    match kind {
        ...
        SymbolKind::TypeDef => 7,
        SymbolKind::FieldSymbol => 8,
        SymbolKind::Form => 9,
        SymbolKind::Parameter => 10,
        SymbolKind::Class => 11,
        SymbolKind::Interface => 12,
        SymbolKind::Method => 13,
        SymbolKind::Field => 14,
        SymbolKind::Include => 15,
        SymbolKind::Event => 16,
        SymbolKind::Module => 17,
        SymbolKind::Control => 18,
        SymbolKind::Report => 19,
    }
}
