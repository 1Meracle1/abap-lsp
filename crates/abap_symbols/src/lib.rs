...
pub use def_map::{
    ...
    ClassMemberParameterData, Diagnostic, DiagnosticKind, ExpressionFactData, ExpressionFactKind,
    ...
    PerformParameterSection, PerformProgramData, ReferenceData, ReferenceKind, Resolution,
    RoutineControlRegionData, RoutineLoopKind, RoutineSiteData, RoutineSiteKind, SqlNameRefData,
    ...
    SymbolKind, SystemFieldStatementKind, SystemFieldUpdateData, TryRegionData, TypeFactData,
    UnitAnalysis, ValueFlowEdgeData, ValueFlowKind, ValueFlowTargetData, ValueStateCheckData,
