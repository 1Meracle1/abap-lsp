...
Walk_Visitor :: struct {
	...
	visit_terminator: proc(visitor: ^Walk_Visitor, module: ^Module, function_id: Function_Id, function: ^Function, block_id: Block_Id, block: ^Block, term: ^Terminator) -> bool,
	data:             rawptr,
}

walk_module :: proc(visitor: ^Walk_Visitor, module: ^Module) -> bool {
	assert(visitor != nil && module != nil)
...
walk_block :: proc(
	...
	if visitor.visit_terminator != nil &&
	   !visitor.visit_terminator(visitor, module, function_id, function, block_id, block, &block.term) {
		return false
	}
	return true
}
