...
DATA lv_date LIKE sy-datum.`
	...
	testing.expect_value(t, selection_screen.kind, ast.Selection_Screen_Kind.Begin_Block)
	testing.expect_value(t, selection_screen.raw_text, "")
	testing.expect_value(t, selection_screen.block_name.text, "b1")
	testing.expect(t, selection_screen.with_frame)
	testing.expect_value(t, selection_screen.title.text, "text-001")
