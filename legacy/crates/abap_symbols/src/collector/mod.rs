...
use crate::def_map::{
    ...
    ConcatenateLinesOfSiteData, ConstructorForBindingData, Diagnostic, DiagnosticKind,
    ...
    InternalTableOrderData, LoopAtFieldContext, LoopWhereFieldContext, MemberAliasData,
    MessageClassEntryData, MessageClassUseData, MessageUseData, NamedArgumentAccess,
    PerformCallData, ReadTableBinarySearchData, ReferenceData, ReferenceKind,
...
pub struct Collector<'a> {
    ...
    concatenate_lines_of_sites: Vec<ConcatenateLinesOfSiteData>,
...
impl<'a> Collector<'a> {
    pub fn new(
        ...
        Self {
            ...
            concatenate_lines_of_sites: Vec::new(),
    ...
    pub fn collect(mut self) -> UnitAnalysis {
        ...
        UnitAnalysis {
            ...
            concatenate_lines_of_sites: self.concatenate_lines_of_sites,
