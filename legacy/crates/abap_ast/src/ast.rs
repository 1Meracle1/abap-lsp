...
ast_node!(ResumeStmt, SyntaxKind::ResumeStmt);
ast_node!(RetryStmt, SyntaxKind::RetryStmt);
ast_node!(TestSeamStmt, SyntaxKind::TestSeamStmt);
ast_node!(TestInjectionStmt, SyntaxKind::TestInjectionStmt);
...
ast_node!(ComputeStmt, SyntaxKind::ComputeStmt);
ast_node!(AddStmt, SyntaxKind::AddStmt);
ast_node!(SubtractStmt, SyntaxKind::SubtractStmt);
ast_node!(MultiplyStmt, SyntaxKind::MultiplyStmt);
ast_node!(DivideStmt, SyntaxKind::DivideStmt);
ast_node!(ArithmeticEntry, SyntaxKind::ArithmeticEntry);
ast_node!(ArithmeticSourceOperand, SyntaxKind::ArithmeticSourceOperand);
ast_node!(ArithmeticTargetOperand, SyntaxKind::ArithmeticTargetOperand);
ast_node!(TextSourceOperand, SyntaxKind::TextSourceOperand);
ast_node!(TextTargetOperand, SyntaxKind::TextTargetOperand);
...
ast_node!(OverlayStmt, SyntaxKind::OverlayStmt);
ast_node!(PackStmt, SyntaxKind::PackStmt);
ast_node!(UnpackStmt, SyntaxKind::UnpackStmt);
ast_node!(SkipStmt, SyntaxKind::SkipStmt);
ast_node!(UlineStmt, SyntaxKind::UlineStmt);
ast_node!(NewLineStmt, SyntaxKind::NewLineStmt);
ast_node!(NewPageStmt, SyntaxKind::NewPageStmt);
ast_node!(ReserveStmt, SyntaxKind::ReserveStmt);
ast_node!(BackStmt, SyntaxKind::BackStmt);
ast_node!(ListControlOperand, SyntaxKind::ListControlOperand);
