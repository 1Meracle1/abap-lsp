...
find_node_at_offset :: proc(node: ^Node, offset: int) -> ^Node {
	...
	case ^Convert_Time_Stamp_To_Date_Time_Stmt:
		if n.stamp != nil {
			if res := find_node_at_offset(&n.stamp.expr_base, offset); res != nil {
				return res
			}
	...
	case ^Set_Bit_Stmt:
		...
		if n.to_value != nil {
			if res := find_node_at_offset(&n.to_value.expr_base, offset); res != nil {
				return res
			}
		}
	...
	case ^Delete_Stmt:
		...
		if n.from_source != nil {
			if res := find_node_at_offset(&n.from_source.expr_base, offset); res != nil {
				return res
			}
		}
		if n.where_cond != nil {
	...
	case ^Translate_Stmt:
		...
		if n.using_pattern != nil {
			if res := find_node_at_offset(&n.using_pattern.expr_base, offset); res != nil {
				return res
			}
		}
	...
	case ^Create_Object_Stmt:
		...
		if n.area_handle != nil {
			if res := find_node_at_offset(&n.area_handle.expr_base, offset); res != nil {
				return res
			}
		}
		for arg in n.exporting {
	...
	case ^Create_Data_Stmt:
		...
		if n.like_ref != nil {
			if res := find_node_at_offset(&n.like_ref.expr_base, offset); res != nil {
				return res
			}
		}
		if n.type_handle != nil {
			if res := find_node_at_offset(&n.type_handle.expr_base, offset); res != nil {
				return res
			}
		}
	...
	case ^Open_Cursor_Stmt:
		...
		if n.select_stmt != nil {
			if res := find_node_at_offset(&n.select_stmt.stmt_base, offset); res != nil {
				return res
			}
		}
